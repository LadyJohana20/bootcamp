...
console.log('-----\nIntegrante 1: "' + capitalizarTexto(nombre1.textContent.trim()) + ' ' + capitalizarTexto(nombre2.textContent.trim()) + '' + capitalizarTexto(apellido1.textContent.trim()) + ' ' + capitalizarTexto(apellido2.textContent.trim()) + '"\n-----');
